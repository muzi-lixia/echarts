...
(function () {
    //实例化对象
    let node = document.querySelector('.bar .chart');
...
(function () {
    ...
    let node = document.querySelector('.line .chart');
    let myChart = echarts.init(node);
    ...
    myChart.setOption(option);
    let ANode = document.querySelectorAll('h2 a');
    ANode.forEach((item,index) => {
        ...
        series: [
            {
                ...
                itemStyle: {
                    ...
                    color: function(params) {
                        // params 传进来的是柱子对象  dataIndex 是当前柱子的索引号
